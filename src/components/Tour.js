...
const TourComponent = ({ runTour, setRunTour }) => {
  const steps = [
    {
      target: '#Sermons1',
      content: 'This Opens a random Sermon from The Prophet of God. A second click will open the side bar for  sermon selection',
    },
    {
      target: '#Sermons',
      content: 'This Opens a random Sermon from The Prophet of God. A second click will open the side bar for  sermon selection',
    ...
    {
      target: '#settings',
      content: 'Change the font size, font family, background color and text color of the sermon text',
    },
    {
      target: '#home',
